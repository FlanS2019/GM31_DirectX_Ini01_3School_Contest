...
public:
	...
	// STEP14: hotbar "use it and it disappears" request -- Door::Interact()
	// and ItemBox::Interact() call this once a key/item has actually been
	// consumed (a door opened, items deposited), so interact.cpp's hotbar
	// stops drawing it. AddKey()/HasKey() above are unchanged.
